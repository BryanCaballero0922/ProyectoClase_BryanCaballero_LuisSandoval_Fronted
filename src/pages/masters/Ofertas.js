  ...
  const ofertas = [
    {
      ...
      description: 'Amortiguador trasero con descuento para mejor amortiguación.',
      priceOriginal: 60.00,
      priceOferta: 45.00,
    },
    {
      ...
      description: 'Juego de 4 bujías de alto rendimiento con oferta especial.',
      priceOriginal: 20.00,
      priceOferta: 16.00,
    },
    {
      id: 3,
      name: 'Filtro de aceite avanzado',
      brand: 'MANN',
      image: 'https://m.media-amazon.com/images/I/81FmeBce0mL._AC_UF894,1000_QL80_.jpg',
      description: 'Filtro de aceite para mantener limpio el motor, ahora en oferta.',
      priceOriginal: 15.00,
      priceOferta: 10.50,
    },
    {
      ...
      description: 'Pastillas con gran durabilidad y descuento especial.',
      priceOriginal: 35.00,
      priceOferta: 28.50,
    },
    {
      ...
      description: 'Radiador eficiente para tu motor, ahora con descuento.',
      priceOriginal: 75.00,
      priceOferta: 60.00,
    }
  ];
